;
(function () {
  System.register(['./modulepreload-polyfill-legacy.8dcb0a50.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function () {
         ...
         * */
        const globalBus = exports('g', new Bus());
        ...
        const QUOTES = ['Next time, it will be 5x faster.', 'Warming up the search experience.', 'A little patience makes better search.', 'Almost there — your results are worth it.'];
        ...
        (async () => {
          ...
          } = await __vitePreload(() => module.import('./suggestions-legacy.2275465f.js'), false ? "__VITE_PRELOAD__" : void 0);
          const redirected = redirectToSuggestions();
          setupResultsLoadedListener();
          if (!redirected) {
            // Load components only after redirects are checked.
            __vitePreload(() => module.import('./add-button-legacy.e27bdb28.js'), false ? "__VITE_PRELOAD__" : void 0);
            __vitePreload(() => module.import('./add-result-legacy.8be3932b.js'), false ? "__VITE_PRELOAD__" : void 0);
            __vitePreload(() => module.import('./result-legacy.e58d612f.js'), false ? "__VITE_PRELOAD__" : void 0);
          }
        })();
      }
    };
